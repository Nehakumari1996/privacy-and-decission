 ...
 */
public class ReadFile1 extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
	             ...
	             else if ((s.startsWith("Content-Disposition")) && (state == 0))
	             {
		               state = 1;
		                ...
		                else
		                {
			                ...
			                System.out.println("File Name : (readfile.java)" + fileName);
			                
			               //--------------------Store File name to data base--------------- 
			                HttpSession session=request.getSession(false);
			                session.setAttribute("filename", fileName);
			                
			               path = request.getRealPath("") +"\\Image\\" + fileName;
     ...
     rd=request.getRequestDispatcher("/jsp/upload_profile_img.jsp");
