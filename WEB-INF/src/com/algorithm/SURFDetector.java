...
public class SURFDetector 
{
    ...
    public static int comparision_process(String im1,String im2) {
       ...
       // String os = System.getProperty("os.name");
        ...
        String bookObject = im1;
        String bookScene = im2;
        ...
        //System.out.println(keypoints[1]);
        ...
        if (goodMatchesList.size() >= 7) {
            ...
            Mat homography = Calib3d.findHomography(objMatOfPoint2f, scnMatOfPoint2f, Calib3d.RANSAC, 4);
    ...
    {
    	  comparision_process("1.jpg","1.jpg");
	}
