 ...
 * @throws IOException 
  */
  public DisplayDEM(RenderedImage image,String oppath) throws IOException
    {
    // Create the iterator
    ...
    // Create an array to receive the pixels values with the appropriate number
    // of bands
    ...
    pixelInfo = new StringBuffer(50);
	  ...
	  //---------------------------
	  BufferedImage img = surrogateImage.getAsBufferedImage();
	  //img.setRGB(255, 0, 0);
	  
	  
	  
	    ImageIO.write(img, "jpg",  new File(oppath));
	 
	    //Cleanup.conert_process("region_growing.jpg", "final_region_growing.jpg");
