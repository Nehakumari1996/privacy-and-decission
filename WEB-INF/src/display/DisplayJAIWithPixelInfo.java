...
public class DisplayJAIWithPixelInfo extends DisplayJAI 
  ...
  {
  private StringBuffer pixelInfo; // the pixel information (formatted as a 
                                  // StringBuffer).
  ...
  private boolean isDoubleType; // indicates which of the above arrays we will 
                                // use.
  ...
  private short[][] lutData; // will contain the look-up table data if isIndexed
                             // is true. 
  ...
  */
  public DisplayJAIWithPixelInfo(RenderedImage image)
    ...
    if (isIndexed)
      ...
      // Load the lookup table data into a short array to avoid 
      // negative numbers.
  ...
  */
  public void mouseMoved(MouseEvent me)
    ...
    if (isDoubleType) // process the pixel as an array of double values
      ...
      pixelInfo = pixelInfo.deleteCharAt(pixelInfo.length()-1); // erase last 
                                                                // comma
      }
